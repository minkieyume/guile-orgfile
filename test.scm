...
doc
;; doc:
;; (document ((__init . #f) (Custome . "custome") (AUTHOR . "Dreamtwi") (title . "Test Title") (__init . #t)) (section ((level . 1) (headline . "A typical org file") (tags "TAG1" "TAG2") (closed . #f)) (section ((level . 2) (headline . "Sections can be nested") (tags) (closed . #f)) (paragraph ((closed . #f)) (text ((closed . #t)) "another paragraph.")) (list ((closed . #t) (last-line-empty . #t) (ordered . 1) (indent . 1)) (item ((indent . 1)) (paragraph ((closed . #f)) (text ((closed . #t)) "List item 2"))) (item ((indent . 1)) (paragraph ((closed . #f)) (text ((closed . #t)) "List item 1")))) (paragraph ((closed . #t) (closed . #f)) (text ((closed . #t)) "#+test_ss"))) (paragraph ((closed . #t) (closed . #f)) (link ((url . "http://example.com") (description . "example link") (closed . #t))) (text ((closed . #t)) "a paragraph with an "))))
